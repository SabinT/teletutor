 ...
 */
public class ChannelAudioManager extends TeleObject implements AudioManager {
...
//    private LANReceiver receiver;
    ...
    public ChannelAudioManager(String name, TeleChannel chan, String mcastAddress, int port, String cname) throws Exception {
        super(name, chan);
